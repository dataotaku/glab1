...
dir_nm = "c:/projects/kosis_dn/시군구_전입_전출_사유_plot/"
title_txt = "시군구_전입전출_사유별_순위변동_추이"
...
doc = BaseDocTemplate(str("c:/projects/kosis_dn/plot_pdf_aggr/" + title_txt +"_" +datetime.now().strftime("%Y-%m-%d")+'.pdf'), pagesize=landscape(A4))
