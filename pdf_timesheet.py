...
class FooterCanvas(canvas.Canvas):
    ...
    def draw_canvas(self, page_count):
        ...
        self.drawImage("c:/projects/glab1/supplier-data/images/001.jpeg", self.width-inch*8-5, self.height-50, width=100, height=20, preserveAspectRatio=True)
        self.drawImage("c:/projects/glab1/supplier-data/images/002.jpeg", self.width - inch * 2, self.height-50, width=100, height=30, preserveAspectRatio=True, mask='auto')
...
class PDFPSReporte:
    ...
    def firstPage(self):
        img = Image('c:/projects/glab1/supplier-data/images/001.jpeg', kind='proportional')
        ...
        img = Image('c:/projects/glab1/supplier-data/images/002.jpeg', kind='proportional')
...
# report = PDFPSReporte('uhc_psreport.pdf')
